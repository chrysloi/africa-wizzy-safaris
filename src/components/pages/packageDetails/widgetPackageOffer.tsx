...
export const WidgetPackageOffer = () => {
  const scrollTop = () => {
            ...
            <li className="package-sm">
              <div className="thumb">
                ...
                >
                  <img
                    src={
                      process.env.PUBLIC_URL + "/images/package/package-sm4.png"
                    }
                    alt="PackageIMG"
                  />
                </Link>
            ...
            <li className="package-sm">
              <div className="thumb">
                ...
                >
                  <img
                    src={
                      process.env.PUBLIC_URL + "/images/package/package-sm3.png"
                    }
                    alt="PackageIMG"
                  />
                </Link>
            ...
            <li className="package-sm">
              <div className="thumb">
                ...
                >
                  <img
                    src={
                      process.env.PUBLIC_URL + "/images/package/package-sm2.png"
                    }
                    alt="PackageIMG"
                  />
                </Link>
            ...
            <li className="package-sm">
              <div className="thumb">
                ...
                >
                  <img
                    src={
                      process.env.PUBLIC_URL + "/images/package/package-sm1.png"
                    }
                    alt="PackageIMG"
                  />
                </Link>
